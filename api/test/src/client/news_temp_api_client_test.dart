...
void main() {
  ...
  group('NewsTempApiClient', () {
    late http.Client httpClient;
    late NewsTempApiClient apiClient;
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => NewsTempApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = NewsTempApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws NewsTempApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<NewsTempApiMalformedResponse>()),
        );
      });

      test(
          'throws NewsTempApiRequestFailure '
