...
/// {@template news_temp_api_malformed_response}
...
class NewsTempApiMalformedResponse implements Exception {
  /// {@macro news_temp_api_malformed_response}
  const NewsTempApiMalformedResponse({required this.error});

  /// The associated error.
  final Object error;
}

/// {@template news_temp_api_request_failure}
/// An exception thrown when an http request failure occurs.
/// {@endtemplate}
class NewsTempApiRequestFailure implements Exception {
  /// {@macro news_temp_api_request_failure}
  const NewsTempApiRequestFailure({
  ...
  Map<String, dynamic> json() {
    try {
      ...
      Error.throwWithStackTrace(
        NewsTempApiMalformedResponse(error: error),
        stackTrace,
      );
    }
  }
